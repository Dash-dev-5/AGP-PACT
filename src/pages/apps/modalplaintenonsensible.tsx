...
function CreatePlainteNonSensible({
    show,
    setShowPlainteNonSensible,
  }: {
    show: boolean;
    setShowPlainteNonSensible: React.Dispatch<React.SetStateAction<boolean>>;
  }) {
     
    const handleClose = () => setShowPlainteNonSensible(false);
      ...
      <>
        <Modal show={show} onHide={handleClose} centered={true} size="lg">
          <Modal.Header closeButton>
            <Modal.Title>Création Plainte Non Sensible</Modal.Title>
          </Modal.Header>
          <Modal.Body>
  ...
  export default CreatePlainteNonSensible;