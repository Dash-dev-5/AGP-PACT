...
import type { CreateSector } from "features/sector/communeType"
                    ...
                    <tr>
                      ...
                      <td>
                        <div className="d-flex gap-2 justify-content-center">
                          <Button disabled={!sector.villages?.length} onClick={() => navigate(sector.id)}>
                            Villages
                          </Button>
        ...
        <Modal.Body>
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="form-group mb-3">
              ...
              <Form.Select id="city" {...register("city")} disabled={!provinceId}>
                <option value="">-- Sélectionnez une ville --</option>
                {cities.map((city) => (
                  <option key={city.id || ""} value={city.id || ""}>
                    {city.name || ""}
