...
import type { DeleteSectorType } from "features/sector/communeType"
...
const DeleteCommune = ({ id, name }: { id: string; name: string }) => {
  ...
  const {
    ...
    defaultValues: {
      id,
      reason: "Bad data" as "Bad data" | "Data created by mistake and more",
    },
  })
    ...
    <>
      ...
      <Modal show={show} onHide={handleClose} centered>
        ...
        <Form onSubmit={handleSubmit(onSubmit)}>
          <Modal.Body>
            <p>
              Voulez-vous vraiment supprimer la commune <strong>{name}</strong> ?
            </p>
