...
import type { UpdateCityType, ICity } from "features/ville/villeType"
          ...
          <Form onSubmit={handleSubmit(onSubmit)}>
            <Modal.Body className="p-4">
              ...
              <div className="form-group mb-3">
                ...
                <Form.Select id="province" {...register("province", { required: "La province est requise" })}>
            ...
            <Modal.Footer className="border-0 justify-content-between">
              ...
              <Button variant="primary" type="submit" className="px-4">
                {updateStatus === "loading" ? <Spinner animation="border" size="sm" /> : "Enregistrer"}
              </Button>
            </Modal.Footer>
          </Form>
        </Modal>
